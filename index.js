...
import { registerEvent } from "./src/handlers/event/event.js";

import { registerAnime } from "./src/handlers/anime.js";
...
async function main() {
  ...
  await bot.start({
    onStart: () =>
      console.log("🤖 ShinBot JS is running... (Pure JS, no Python!)"),
  });
}
